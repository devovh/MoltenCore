...
public:
    ...
    {
        return sEluna->OnCommand(handler, cmdStr.data());
    }
};
...
public:
    ...
    {
        return sEluna->OnAreaTrigger(player, trigger);
    }
};
...
public:
    ...
    {
        return sEluna->OnPacketSend(session, packet);
    }

    bool CanPacketReceive(WorldSession* session, WorldPacket& packet) override
    {
        return sEluna->OnPacketReceive(session, packet);
    }
};
